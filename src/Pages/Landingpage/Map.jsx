...
const Map = () => {
  return (
    <div className='flex flex-col justify-center items-center h-screen space-y-4 text-black'>
      <h1 className='text-3xl font-medium mb-8'>Lokasi Carlos Tech</h1>
      <iframe
        ...
        className='border-0 w-full h-3/4 xsm:w-4/5 md:w-3/4 md:h-3/4 lg:w-1/2 lg:h-1/2 p-4'
        allowFullScreen=''
        loading='lazy'
