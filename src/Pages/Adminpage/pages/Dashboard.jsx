...
const Dashboard = () => {
  ...
  useEffect(() => {
    axios
      .get('https://api.carlostech.id/api/v1/users/total-users')
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get('https://api.carlostech.id/api/v1/reservations/total-reservations', {
        headers: {
  ...
  useEffect(() => {
    axios
      .get(`https://api.carlostech.id/api/v1/reservations/monthly-revenue`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        params: {
